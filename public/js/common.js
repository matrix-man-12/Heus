...
$(document).on("click",".likeButtonNew",(event)=>{
    var button = $(event.target);
    var postId = getPostIdFromElement(button);
...
function createPostHtml(postData, largeFont = false){
    ...
    if (postData.postedBy._id == userLoggedIn._id) {
        ...
        buttons = `<button class="pinButtons ${pinnedClass}" data-id="${postData._id}" data-toggle="modal" data-target="${dataTarget}"><i class='fas fa-thumbtack'></i></button>
                    ...
                    <div class="postContentContainer">
                        ...
                        <div class="postFooter">
                            ...
                            <div class='postButtonContainer red'>
                                <button class='likeButtonNew ${likeButtonActiveClass}'>
